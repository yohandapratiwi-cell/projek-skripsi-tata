...
import { 
  ArrowLeft, MessageSquare, BookOpen, Loader2, XCircle, FileText
} from "lucide-react";
        ...
        {reflections.length > 0 ? (
          reflections.map((item) => (
            <div key={item.submission_id} className="bg-slate-900/50 border border-slate-800 p-8 rounded-[48px] hover:border-purple-500/30 transition-all group shadow-xl">
              ...
              <div className="bg-slate-950/70 p-6 rounded-[32px] border border-slate-850 relative overflow-hidden group-hover:border-purple-500/10 transition-all">
